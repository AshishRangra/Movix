...
<Routes>
  ...
  <Route path="/:mediaType/:id" element={isLoggedIn ?<Details />: <Navigate to="/login2" />} />
  <Route path="/search/:query" element={isLoggedIn ?<SearchResult />: <Navigate to="/login2" />} />
  <Route path="/explore/:mediaType" element={isLoggedIn ?<Explore />: <Navigate to="/login2" />} />

  <Route path="/register" element={isLoggedIn ?<Register />: <Navigate to="/login2" />}/>
  <Route path="*" element={<PageNotFound />} />
  <Route
    path="/changePass"
    element={changePass ? <ChangePassword /> : <Navigate to="/login2" />}
  />
  <Route
    path="/"
    element={isLoggedIn ? <Home /> : <Navigate to="/login2" />}
